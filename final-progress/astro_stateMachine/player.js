function Player() {
  ...
  this.update = function() {
    ...
    // interaction
    if (keyCode === UP_ARROW) {
      if (level[floor((this.centeredSprite.y - 16) / cellSize)][floor(this.centeredSprite.x / cellSize)] === 0) {
    ...
    if (keyCode === LEFT_ARROW) {
      if (level[floor(this.centeredSprite.y / cellSize)][floor((this.centeredSprite.x - 16) / cellSize)] === 0) {
